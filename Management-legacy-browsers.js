...
function instruRoutineBegin(snapshot) {
  return async function () {
    ...
    instruComponents.forEach( function(thisComponent) {
...
function background2RoutineBegin(snapshot) {
  return async function () {
    ...
    background2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function y_1RoutineBegin(snapshot) {
  return async function () {
    ...
    y_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function y_2RoutineBegin(snapshot) {
  return async function () {
    ...
    y_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function y_3RoutineBegin(snapshot) {
  return async function () {
    ...
    y_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function y_4RoutineBegin(snapshot) {
  return async function () {
    ...
    y_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
